...
export default function ContactUs() {
  ...
  return (
    <main>
      <nav className="flex flex-row justify-between items-center p-8 bg-purple-50 dark:bg-purple-900">
        <div className="relative flex flex-row space-x-2 items-center">
          <div className="absolute h-6 w-4 bg-purple-500 z-10"></div>
      ...
      <header className="p-8 grid grid-cols-1 md:grid-cols-2 gap-4 pt-10 lg:px-40 bg-purple-50 dark:bg-purple-900 md:h-96">
        ...
        <form
          ...
          className="rounded-lg shadow-xl flex flex-col px-8 py-8 bg-white dark:bg-purple-500"
        >
