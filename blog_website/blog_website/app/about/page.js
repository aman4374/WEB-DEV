            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  My coding journey began in college when I stumbled upon his first programming language—Python. What started as a simple curiosity quickly turned into a passion, as I spent countless hours experimenting with code, building small projects, and learning the fundamentals of software development.
                </p>
              </div>
            </div>
