...
export function Video({ videoId }) {
  ...
  return (
    <Container>
      <div className="relative w-full h-[500px] max-w-4xl mx-auto overflow-hidden lg:mb-20 rounded-2xl bg-red-300 cursor-pointer bg-gradient-to-tr from-red-400 to-red-700">
        {!playVideo && (
          <button
